 ...
 * {@link TacheRecupCallable}</p>
 * <p>Les erreurs de collecte sont due à une incapacité de la tache à récupérer le contenu (site indisponible,
...
public class CollecteIncident extends AbstrIncident implements Serializable {
    ...
    /**
     * Une erreur de collecte est forcement lié à un flux. Un incident ne possède qu'un flux. Un flux peut posséder
     * plusieurs incidents.
     */
    ...
    /**
     * *
     * Une erreur de collecte ne doit être notifiée que si elle a subit 3 répétitions et que la durée soit > a 3 heures.
     * Il faut en effet éviter de notifier dès le premier échec.
     *
     * @return
     */
    @Override
